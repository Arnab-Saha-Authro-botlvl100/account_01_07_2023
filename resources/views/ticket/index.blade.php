<x-app-layout>
    ...
    px-2  text-gray-900">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="ticket_invoice_type" id="multiple_ticket" value="multiple_ticket">
        <label class="form-check-label" for="inlineRadio1">Multiple Ticket</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="ticket_invoice_type" id="single_ticket" value="single_ticket">
        <label class="form-check-label" for="inlineRadio2">Single Ticket</label>
      </div>
    ...
    <div class="border-t bg-white border-gray-2 flex flex-col justify-center items-center p-6 rounded-lg shadow-md xl:w-3/4 lg:w-4/4 w-full mx-auto my-2">
        ...
        <form class="w-full" id="ticket_form_single" action="{{ route('addsingleticket.store') }}" method="POST">
            @csrf
                <div class="grid grid-cols-2 w-full gap-3">
