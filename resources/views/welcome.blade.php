...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            <div>
                <div class="sticky py-4 px-auto flex justify-between bg-white top-0 z-50 w-[95%] mx-auto md:w-[75%] items-center">
                    ...
                    <div class="" >
                        ...
                        {{-- @if (Auth::user()->email === 'admin@example.com') <!-- Check if the user is an admin --> --}}
                            {{-- <li class="nav-item"> --}}
        ...
        <div class="hero bg-dots-darker bg-center dark:bg-dots-darker dark:bg-gray-900 selection:bg-red-500 selection:text-white bg-[#00959F]">
            <div class="min-h-[80vh] md:gap-x-14 sm:flex md:justify-between items-center w-[95%] mx-auto md:w-[75%] md:items-center">
                <div class="md:w-[48%] w-[100%] md:py-0 py-8 md:text-start text-center">
                    <h2 class='font-extrabold text-white md:text-5xl text-3xl'>Best Accounting Software Travel Agency in Bangladesh</h2>
                    <p class="font-semibold mt-3 md:text-xl text-lg text-gray-300">Introducing simple and easy to use accounting software specially designed for travel agencies</p>
                    <button class="border-2 border-gray-300 text-gray-300 py-2 px-5 hover:bg-gray-300 duration-300 hover:text-gray-900 font-semibold text-lg mt-5 rounded-lg">Contact</button>
                </div>
        ...
        <footer class="p-5 flex justify-between items-center">
            ...
            <div>
                <a href="http://" class="p-2 shadow-lg rounded-full"><i class="fa fa-facebook fa-brands text-xl text-blue-500"></i></a>
            </div>
        </footer>
    </body>
</html>
