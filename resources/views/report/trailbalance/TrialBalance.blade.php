   ...
   <div class="">
        ...
        <table class=" table-auto w-full border-2 border-gray-400 devide-2 text-lg my-1">
            ...
            <tbody class="divide-y-2">
              ...
              @endforeach
              @foreach ($agents as $name => $amount)
                  <tr>
                      <td class="w-[70%] px-2 py-2">{{ $name }}<span class="text-danger">&nbsp;(Agent)</span></td>
                      <td class="text-end px-2 py-2">{{ $amount }}</td>
                      <td class="text-end px-2 py-2">0</td> <!-- No credit for agents -->
                  </tr>
              @endforeach

              <!-- Display suppliers data -->
              @foreach ($suppliers as $name => $amount)
                  <tr>
                      <td class="w-[70%] px-2 py-2">{{ $name }}<span class="text-danger">&nbsp;(Supplier)</span></td>
                      <td class="text-end px-2 py-2">0</td> <!-- No debit for suppliers -->
                      <td class="text-end px-2 py-2">{{ $amount }}</td>
                  </tr>
              @endforeach
