...
class ReportController extends Controller
{
    ...
    //             if ($model) {
    //                 $transaction['agent_supplier_name'] = $model->name . ' (<span style="color: red;">' . $transaction['receive_from'] . '</span>)';
    ...
    //                 $transaction['due_amount'] = $model->amount;
    ...
    public function sales_report_ticket(Request $request)
    {
        ...
        foreach ($alldata as $data) {
            ...
            $count++;
            $updated_balance += $data->agent_price;
            $htmlTable .= '<tr>
            ...
            $htmlTable .= '<td class="py-2">' . $updated_balance . '</td>
                    </tr>';
        }
        ...
        $htmlTable .= '
                         <td class="text-start py-2"><b>' . $updated_balance . '</td>
                        </tr>
                        </tbody></table>';
